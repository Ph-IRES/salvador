...
A short presentation of the study's main results, which was used to present at the annual American Geophysical Union Conference, can be downloaded from the file AGUpresentation.mp4. 
